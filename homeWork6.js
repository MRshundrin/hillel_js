...
// Якщо використовувати будь-які вбудовані функції заборонено, то маємо на увазі, що всі літеру у одному регістрі, якщо
// можливий різний регістр, то потрібно додати toLowerCase() при порівнянні символів строки

// для строк без пробілів (якщо не можна прибрати пробіли через string.split(' ').join('');
{
...
// для строк з пробілами (якщо у першому варіанті можна прибрати пробіли через string.split(' ').join(''),
